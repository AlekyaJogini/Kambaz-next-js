...
import { FaPencil } from "react-icons/fa6";  // ✅ ADD THIS IMPORT
import { FaCheck } from "react-icons/fa";  // ✅ ADD THIS IMPORT
import { IoCloseSharp } from "react-icons/io5";
import { FormControl } from "react-bootstrap";  // ✅ ADD THIS IMPORT
...
export default function PeopleDetails({ 
  ...
  const [editing, setEditing] = useState(false);  // ✅ ADD THIS
  ...
  return (
    <div className="wd-people-details position-fixed top-0 end-0 bottom-0 bg-white p-4 shadow w-25">
      ...
      {/* ✅ REPLACE THE NAME DIV WITH THIS: */}
