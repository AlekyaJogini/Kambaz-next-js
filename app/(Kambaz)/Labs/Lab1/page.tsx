"use client";export default function Lab1() {
  return (
    <div id="wd-lab1">
      <h2>Lab 1</h2>
      <h3>HTML Examples</h3>
      ...
      <div id="wd-lists">
        ...
        My favorite recipe:
        <ol id="wd-chicken-biryani">
          <li>Soak basmati rice in water for 30 minutes.</li>
          <li>Cut chicken into pieces and marinate with yogurt, ginger-garlic paste, and spices.</li>
          <li>Heat ghee and fry sliced onions until golden brown.</li>
          <li>Add marinated chicken and cook.</li>
          <li>In other pot boil water with whole spices and cook rice until 70% done.</li>
          <li>Layer the half cooked rice over the chicken.</li>
          <li>Sprinkle fried onions, mint leaves.</li>
          <li>Cover with aluminum foil and then place the lid and cook on high heat for 2 minutes.</li>
          <li>Reduce heat to low and cook for 45 minutes.</li>
          <li>Turn off heat and let it rest for 10 minutes before opening.</li>
          <li>Gently mix and serve hot with raita.</li>
        </ol>
